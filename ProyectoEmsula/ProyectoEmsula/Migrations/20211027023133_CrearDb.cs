        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    TipoReferenciaCliente = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TelefonoNegocio = table.Column<string>(nullable: true),
                    ...
                    ordenLunes = table.Column<string>(nullable: true),
                    ordenMartes = table.Column<string>(nullable: true),
                    ordenMiercoles = table.Column<string>(nullable: true),
                    ordenJueves = table.Column<string>(nullable: true),
                    ordenViernes = table.Column<string>(nullable: true),
                    ordenSabado = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Aperturas", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Aperturas_Canals_canalid",
                        column: x => x.canalid,
                        principalTable: "Canals",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Aperturas_CaracteristicaZonas_caracteristicaZonaid",
                        column: x => x.caracteristicaZonaid,
                        principalTable: "CaracteristicaZonas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Aperturas_Ciudads_ciudadid",
                        column: x => x.ciudadid,
                        principalTable: "Ciudads",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Aperturas_Companias_companiaid",
                        column: x => x.companiaid,
                        principalTable: "Companias",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Aperturas_Departamentos_departamentoid",
                        column: x => x.departamentoid,
                        principalTable: "Departamentos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Aperturas_FormaAtencions_formaAtencionid",
                        column: x => x.formaAtencionid,
                        principalTable: "FormaAtencions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Aperturas_PuntoPos_puntoPosid",
                        column: x => x.puntoPosid,
                        principalTable: "PuntoPos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Aperturas_PuntoRejas_puntoRejasid",
                        column: x => x.puntoRejasid,
                        principalTable: "PuntoRejas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Aperturas_Ramos_ramoid",
                        column: x => x.ramoid,
                        principalTable: "Ramos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Aperturas_Segmentacions_segmentacionid",
                        column: x => x.segmentacionid,
                        principalTable: "Segmentacions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Aperturas_Segmentos_segmentoid",
                        column: x => x.segmentoid,
                        principalTable: "Segmentos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Aperturas_Tamanos_tamanoid",
                        column: x => x.tamanoid,
                        principalTable: "Tamanos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Aperturas_Territorios_territorioid",
                        column: x => x.territorioid,
                        principalTable: "Territorios",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Aperturas_TipoClientes_tipoClienteid",
                        column: x => x.tipoClienteid,
                        principalTable: "TipoClientes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Aperturas_TipoEmpresas_tipoEmpresaid",
                        column: x => x.tipoEmpresaid,
                        principalTable: "TipoEmpresas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Aperturas_TipoReferencias_tipoReferenciaid",
                        column: x => x.tipoReferenciaid,
                        principalTable: "TipoReferencias",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Aperturas_TipoZonas_tipoZonaid",
                        column: x => x.tipoZonaid,
                        principalTable: "TipoZonas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Aperturas_ZonaEntregas_zonaEntregaid",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Aperturas_canalid",
                table: "Aperturas",
                column: "canalid");

            migrationBuilder.CreateIndex(
                name: "IX_Aperturas_caracteristicaZonaid",
                table: "Aperturas",
                column: "caracteristicaZonaid");

            migrationBuilder.CreateIndex(
                name: "IX_Aperturas_ciudadid",
                table: "Aperturas",
                column: "ciudadid");

            migrationBuilder.CreateIndex(
                name: "IX_Aperturas_companiaid",
                table: "Aperturas",
                column: "companiaid");

            migrationBuilder.CreateIndex(
                name: "IX_Aperturas_departamentoid",
                table: "Aperturas",
                column: "departamentoid");

            migrationBuilder.CreateIndex(
                name: "IX_Aperturas_formaAtencionid",
                table: "Aperturas",
                column: "formaAtencionid");

            migrationBuilder.CreateIndex(
                name: "IX_Aperturas_puntoPosid",
                table: "Aperturas",
                column: "puntoPosid");

            migrationBuilder.CreateIndex(
                name: "IX_Aperturas_puntoRejasid",
                table: "Aperturas",
                column: "puntoRejasid");

            migrationBuilder.CreateIndex(
                name: "IX_Aperturas_ramoid",
                table: "Aperturas",
                column: "ramoid");

            migrationBuilder.CreateIndex(
                name: "IX_Aperturas_segmentacionid",
                table: "Aperturas",
                column: "segmentacionid");

            migrationBuilder.CreateIndex(
                name: "IX_Aperturas_segmentoid",
                table: "Aperturas",
                column: "segmentoid");

            migrationBuilder.CreateIndex(
                name: "IX_Aperturas_tamanoid",
                table: "Aperturas",
                column: "tamanoid");

            migrationBuilder.CreateIndex(
                name: "IX_Aperturas_territorioid",
                table: "Aperturas",
                column: "territorioid");

            migrationBuilder.CreateIndex(
                name: "IX_Aperturas_tipoClienteid",
                table: "Aperturas",
                column: "tipoClienteid");

            migrationBuilder.CreateIndex(
                name: "IX_Aperturas_tipoEmpresaid",
                table: "Aperturas",
                column: "tipoEmpresaid");

            migrationBuilder.CreateIndex(
                name: "IX_Aperturas_tipoReferenciaid",
                table: "Aperturas",
                column: "tipoReferenciaid");

            migrationBuilder.CreateIndex(
                name: "IX_Aperturas_tipoZonaid",
                table: "Aperturas",
                column: "tipoZonaid");

            migrationBuilder.CreateIndex(
                name: "IX_Aperturas_zonaEntregaid",
                table: "Aperturas",
